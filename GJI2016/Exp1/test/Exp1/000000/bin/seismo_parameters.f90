...
REAL(KIND=CUSTOM_REAL), PARAMETER :: VEL_BOT=2200 
! damping
...
!! DD par
REAL(KIND=CUSTOM_REAL), PARAMETER :: cc_threshold=0.90 
...
CHARACTER (LEN=MAX_STRING_LEN) :: precond_name='Hessian2_kernel'
