        ...
        MODULE DEFINE_EXTERNAL_MODEL__genmod
          INTERFACE 
            SUBROUTINE DEFINE_EXTERNAL_MODEL(COORD,MATERIAL_ELEMENT,    &
     &IBOOL,RHO,VP,VS,QKAPPA_ATTENUATION,QMU_ATTENUATION,GRAVITY,NSQ,C11&
     &,C13,C15,C33,C35,C55,C12,C23,C25,NSPEC,NGLOB)
          ...
          END INTERFACE 
        END MODULE DEFINE_EXTERNAL_MODEL__genmod
